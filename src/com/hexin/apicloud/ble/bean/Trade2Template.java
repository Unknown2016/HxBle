 ...
 * @author 军刀
 */
public class Trade2Template {
	
	/**
	 * 订单编号，主键
	 */
	@JSONField(name="trades.tid")
	private String tid;
	 ...
	 * 寄件人姓名
	 */
	@JSONField(name="shippingInfo.contact")
	private String seName;

	/**
	 * 寄件人手机
	 */
	@JSONField(name="shippingInfo.phone")
	 ...
	 * 寄件人省份
	 */
	@JSONField(name="shippingInfo.state")
	private String seProvince;

	/**
	 * 寄件人城市
	 */
	@JSONField(name="shippingInfo.city")
	private String seCity;

	/**
	 * 寄件人区域
	 */
	@JSONField(name="shippingInfo.district")
	private String seArea;

	/**
	 * 寄件人详细地址
	 */
	@JSONField(name="shippingInfo.address")
	 ...
	 * 品类
	 */
	@JSONField(name="trades.orders.title")
	private String category;
	
	/**
	 * 宝贝数量
	 */
	@JSONField(name="trades.orders.num")
	private String num;
	 ...
	 * 保价费
	 */
	@JSONField(name="addedServices.servInsureAmount")
	 ...
	 * 大头笔
	 */
	@JSONField(name="thermalExdata.markDestination")
	private String markDestination;

	/**
	 * 集包地
	 */
	@JSONField(name="thermalExdata.packageCenterName")
	private String packageCenterName;
	
	/**
	 * 集包地代码
	 */
	@JSONField(name="thermalExdata.packageCenterCode")
	...
	public String getPackageCenterCode() {
		if(StringUtil.isEmpty(packageCenterCode) && this.thermalExdata != null){
			return this.thermalExdata.getPackageCenterCode();
		}
