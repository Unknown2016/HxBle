...
public class PrintBitmapItem implements BitmapListener {
	...
	public PrintBitmapItem(Template template,Pagedetails pagedetails,int imgNum,int printType) {
		super();
	...
	public void onFinish(Bitmap bmp, boolean arg1) {
		if(bmp != null){
			try {
				HPRTPrinterHelper.Expanded("" + NumberUtil.mm2Dot(pagedetails.getX().add(template.getCalibrationX())),"" + NumberUtil.mm2Dot(pagedetails.getY().add(template.getCalibrationY())),bmp,(byte)0);
