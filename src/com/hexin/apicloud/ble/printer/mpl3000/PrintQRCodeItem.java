...
public class PrintQRCodeItem implements IPrintTemplateItem {
	...
	public void printItem(Printer printer,Template template,Pagedetails pagedetails,Trade trade) throws Exception{
		...
		printer.draw_barcode_QRcode(NumberUtil.mm2Dot(pagedetails.getX().add(template.getCalibrationX())), NumberUtil.mm2Dot(pagedetails.getY().add(template.getCalibrationY())), ver,pagedetails.getItemValue(),false);
	}
